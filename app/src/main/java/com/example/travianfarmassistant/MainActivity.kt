...
class MainActivity : Activity() {
        ...
        webView.webViewClient = object : WebViewClient() {
            override fun onPageFinished(view: WebView?, url: String?) {
                ...
                if (villageScanActive) {
                    handler.postDelayed({ collectCurrentVillageData() }, 700)
                    return
                }
    ...
    private fun visitNextVillageForScan() {
        ...
        // Klik .listEntry berdasarkan data-did. Ini benar-benar mengikuti
        // baris village yang terlihat di sidebar, bukan menebak nama dari h1.
        ...
        val js = """
            (() => {
                ...
                if (entry) {
                    ...
                    const a = entry.querySelector('a[href]');
                    if (a) { a.click(); return 'clicked-link'; }
                    entry.click();
